...
$rcmail_config['cas_imap_name'] = 'imap://mailobm.openroad.vn';

// name of the SMTP service. Will only be used if cas_proxy is set to true.
//     This service name must be authorized to be used with the CAS server.
//$rcmail_config['cas_smtp_name'] = 'name_of_smtp_service';
$rcmail_config['cas_smtp_name'] = 'smtp://mailobm.openroad.vn';
...
$rcmail_config['cas_hostname'] = 'cas.openroad.vn';

// CAS server port number.
$rcmail_config['cas_port'] = 8443;
...
//     'self' or 'ca'.
$rcmail_config['cas_cert'] = '/etc/obm/certs/cas_server_certs.pem';
